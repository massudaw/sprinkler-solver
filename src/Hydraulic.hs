...
data TabelaPerda a = TabelaPerda
  { section :: Section a,
...
data FluidType = Water | Air
  deriving (Eq, Ord, Show)

data Fluido a = Fluido
  { viscosity :: [((a, a), a)],
    density :: [((a, a), a)],
    fluidName :: FluidType
  }
